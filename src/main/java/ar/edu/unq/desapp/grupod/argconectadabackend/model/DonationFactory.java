...
public class DonationFactory {
	...
	public static Donation anyDonation() {
		...
		Donation anyDonation = new Donation(anyDonor, anyDonor.getName(), 1000, dateTime,"aCommentary");
	...
	public static Donation firstDayOfMonthDonation() {
		...
		User anyDonor = UserFactory.anyDonor();
		Donation firstDayOfMonthDonation = new Donation(anyDonor, anyDonor.getName(), 1000, dateTime,"aCommentary");
	...
	public static Donation lastDayOfMonthDonation() {
		...
		User anyDonor = UserFactory.anyDonor();
		Donation lastDayOfMonthDonation = new Donation(anyDonor, anyDonor.getName(), 1000, dateTime,"aCommentary");
	...
	public static Donation beforeMonthDonation() {
		...
		User anyDonor = UserFactory.anyDonor();
		Donation beforeMonthDonation = new Donation(anyDonor, anyDonor.getName(), 1000, dateTime,"aCommentary");
	...
	public static Donation afterMonthDonation() {
		...
		User anyDonor = UserFactory.anyDonor();
		Donation afterMonthDonation = new Donation(anyDonor, anyDonor.getName(), 1000, dateTime,"aCommentary");
	...
	public static Donation emptyDonation() {
		...
		Donation emptyDonation = new Donation(emptyDonor, emptyDonor.getName(), 0, LocalDateTime.MIN,"no donations yet");
